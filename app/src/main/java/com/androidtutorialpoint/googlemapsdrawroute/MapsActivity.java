...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    int mMode=0;
    final int MODE_COLOR_BLUE=0;
    final int MODE_COLOR_RED=1;
    ...
    private String getUrl(LatLng origin, LatLng dest) {
        ...
        for(int i=2;i<MarkerPoints.size();i++){
            ...
            if (i==3)
                endding = "finalEnd=";
            endding += point.latitude + "," +point.longitude +"|";
        ...
        String parameters = str_origin + "&" + str_dest  + "&" +sensor+"&" + waypoints+"&"+""+endding;
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                //chage line color
                if (mMode==MODE_COLOR_BLUE)
                    lineOptions.color(Color.BLUE);
                else if(mMode==MODE_COLOR_RED)
